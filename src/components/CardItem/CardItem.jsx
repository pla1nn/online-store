import { Card, CardQuantity, DecrementButton, IncrementButton } from './CardItem.styled';
...
export const CardItem = ({ item }) => {
  ...
  return (
    <Card>
      <img src={require('../../images/gray.png')} alt={item.name} />
